...
<Steps>
  <Step title="Open model settings">
    ...
    it through the built-in [DSH Model Config](../built-in-plugins/dsh-tauri-model-config) plugin.
  </Step>
...
<Note>
  ...
  [DSH Model Config](../built-in-plugins/dsh-tauri-model-config). For upstream routing and

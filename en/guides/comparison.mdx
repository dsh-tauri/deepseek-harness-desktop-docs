...
<Note>
  ...
  2026-09-25. “Not confirmed” means the public material makes no clear promise; it does not
...
and optional LAN access. Official installers target Windows x64 and macOS Universal; Linux
packages ship only on the `-next` line.
...
and plugin protection. It ships Windows installer and portable packages plus Linux
DEB/AppImage; macOS Apple Silicon remains only on the earlier v5.1.0. Its `.rpm`/`.pacman`
packages stay on the separate v4.x `-linux` line.
...
| macOS Apple Silicon | ✅ DMG | ✅ Universal DMG | ✅ DMG / ZIP | ◐ v5.1.0 only |
| macOS Intel | ✅ DMG | ✅ Universal DMG | ✅ DMG / ZIP | — |
| Linux x64 | ✅ DEB / AppImage | ◐ separate `-next` line | — | ✅ DEB / AppImage |
| No user-installed Node.js required | ✅ | ✅ | ✅ | ✅ |
| Homebrew installation | ✅ | — | — | — |

EAC maintains `.rpm`/`.pacman` only on the separate v4.x `-linux` line, and anywhere-labs
publishes Linux packages only on the `-next` line.
...
| Turn change tracking | ✅ bundled `dsh-tauri-running-changes`, restore via the dsh-rewind preset | Not confirmed | Not confirmed | ✅ bundled line diff/restore |
...
The following comes from the public [dsh-tauri Roadmap](https://github.com/orgs/dsh-tauri/projects/3/views/2).
...
| --- | --- | --- | --- |
| Scheduled tasks (`dsh-tauri-panel-scheduler`) | In Progress | P2 · 2026-Q4 | Plugin is bundled; refine scheduling and run history |
| Remote connection | In Progress | P2 · 2026-Q4 | Explore optional access beyond loopback |
| Pull Request support | In Progress | P2 | Connect worktrees, branch handback, and collaboration |
| Plugin/UI UX improvements | Planned | P2 · 2026-Q4 | Improve the first-party plugins and `dsh-tauri-ui` |
| v1.0 release | Planned | P1 · 2026-Q4 | Feature freeze, alpha, beta, then stable |
| Task panel (task) | Planned | P2 · 2025-Q4 | Provide a task view; still in planning |

The Mint bilingual docs repository is now **Shipped** and no longer appears above. The roadmap
also includes **Idea**-stage candidates such as feature research, a website redesign, and
low-priority built-in dsh plugin management. Idea means research direction; this page does not
call them “coming soon.”
...
- [This project](https://github.com/dsh-tauri/deepseek-harness-desktop) and [releases](https://github.com/dsh-tauri/deepseek-harness-desktop/releases)
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) and [v2.0.14-next](https://github.com/anywhere-labs/dsh-desktop/releases/tag/v2.0.14-next)
- [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) and [v0.9.2](https://github.com/dataelement/dsh-desktop/releases/tag/v0.9.2)
- [Deepseek Harness EAC](https://github.com/zouyuxuan122/Deepseek-Harness-EAC) and [v5.3.6](https://github.com/zouyuxuan122/Deepseek-Harness-EAC/releases/tag/v5.3.6)

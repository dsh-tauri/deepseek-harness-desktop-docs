...
<Tabs>
  <Tab title="Summary">
    <Frame>
      <img src="/images/en/dsh-tauri-turnrewind.png" alt="Turn file-change summary at the end of the conversation" />
    </Frame>
  </Tab>
  <Tab title="Details">
    <Frame>
      <img src="/images/en/dsh-tauri-turnrewind-changes.png" alt="Expanded file list with undo and review actions" />
    </Frame>
  </Tab>
</Tabs>
...
[View source and the complete protocol](https://github.com/dsh-tauri/deepseek-harness-desktop/tree/main/packages/dsh-tauri-turnrewind)

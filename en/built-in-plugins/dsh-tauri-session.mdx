...
See the source and implementation details in [`packages/dsh-tauri-session`](https://github.com/dsh-tauri-desk/deepseek-harness-desktop/tree/main/packages/dsh-tauri-session).

...
<CardGroup cols={2}>
  ...
  <Card title="DSH Tauri Running Changes" icon="file-pen" href="./dsh-tauri-running-changes">
    Shows the files and `+N -M` line counts changed while an Agent turn runs.
  </Card>
  ...
  <Card title="DSH Tauri Model Config" icon="sliders" href="./dsh-tauri-model-config">
    Provides model parameter settings and endpoint compatibility options.
  </Card>
</CardGroup>

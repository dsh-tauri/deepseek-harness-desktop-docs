...
<Note>
  Built-in plugins require Harness core **0.1.5-rc.2** or later. Earlier cores do not provide the
...
<CardGroup cols={2}>
  ...
  <Card title="DSH Model Config" icon="sliders" href="./dsh-tauri-model-config">
    Takes over the model settings page and adds context and output limits, image input, thinking
    modes, and local-endpoint compatibility options.
  </Card>
...
Source is available in the [`packages/`](https://github.com/dsh-tauri/deepseek-harness-desktop/tree/main/packages) directory of the desktop repository.

...
See the source and extension protocol in [`packages/dsh-tauri-rightclick`](https://github.com/dsh-tauri-desk/deepseek-harness-desktop/tree/main/packages/dsh-tauri-rightclick).
